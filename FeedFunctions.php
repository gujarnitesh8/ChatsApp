...
class FeedFunctions
{
    ...
    public function call_service($service, $postData)
    {
        switch ($service) {
            ...
            case "GetAllPosts": {
                return $this->getAllPosts($postData);
            }
                break;
...
//                        }
    ...
    function uploadMediasToFeed($index, $feedIdArr, $userId, &$isQuerySuccess, $keyMedia, $postType)
    {
        $status = FAILED;
        $posts = array();
...
//            }
    ...
    function getFollowUserFeeds($postData)
    {
        $userId = validateObject($postData, 'user_id', 0);
        $userId = addslashes($userId);
    ...
    function addMediaObjectToFeed(&$val)
    {
    ...
    function likeUnlikePosts($postData)
    {
...
//                                            $dataNotiArr['show_in_foreground']= true;
    ...
    function addFavoritePost($postData)
    {
    ...
    function addCommentsToFeed($postData)
    {
...
//    }
    ...
    function likeComments($postData)
    {
        $isTest = IS_TEST_DATA;
    ...
    function listSavedPost($postData)
    {
        $userId = validateObject($postData, 'user_id', 0);
        $is_testdata = validateObject($postData, 'is_testdata', 0);
    ...
    function createFeedMediaDirectory()
    {
    ...
    function getMediaPrefixUrlBasedOnType($mediaType)
    {
